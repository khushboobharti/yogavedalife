...
object Res {
    ...
    object Icon {
        ...
        const val google = "/google_round.svg"
        const val body = "/body.svg"
        const val health = "/health.svg"
        const val stress = "/stress.svg"
        const val icon1 = "/icon-1.svg"
        const val icon2 = "/icon-2.svg"
        const val icon3 = "/icon-3.svg"
        const val icon4 = "/icon-4.svg"
        const val icon5 = "/icon-5.svg"
        const val icon6 = "/icon-6.svg"
        const val icon7 = "/icon-7.svg"
    }
    object PathIcon {
...
object Id {
    ...
    object ConsultForm {
        ...
        const val emailInput = "emailInput"
        const val addressInput = "addressInput"
