        ...
        fetchLatestPosts(
            ...
            onSuccess = {
                if (it is ApiListResponse.Success) {
                    ...
                    if (it.data.size >= Constants.POSTS_PER_PAGE) showMoreLatestPosts = true
                }
            },
            onError = {}
        )
        ...
        fetchPopularPosts(
            ...
            onSuccess = {
                if (it is ApiListResponse.Success) {
                    ...
                    if (it.data.size >= Constants.POSTS_PER_PAGE) showMorePopularPosts = true
                }
            },
            onError = {}
        )
                        ...
                        onSuccess = { response ->
                            if (response is ApiListResponse.Success) {
                                if (response.data.isNotEmpty()) {
                                    if (response.data.size < Constants.POSTS_PER_PAGE) showMoreLatestPosts =
                                        false
                ...
                scope.launch {
                    fetchPopularPosts(
                        ...
                        onSuccess = { response ->
                            if (response is ApiListResponse.Success) {
                                if (response.data.isNotEmpty()) {
                                    if (response.data.size < Constants.POSTS_PER_PAGE) showMorePopularPosts = false
