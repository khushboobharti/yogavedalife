...
fun PostPage() {
    ...
    val hasPostIdParam = remember(key1 = context.route) {
        context.route.params.containsKey(Constants.POST_ID_PARAM)
    }
    ...
    LaunchedEffect(key1 = context.route) {
        ...
        if (hasPostIdParam) {
            val postId = context.route.params.getValue(Constants.POST_ID_PARAM)
    ...
    Column(
        ...
        SpanText(
            modifier = Modifier
                ...
                .fontFamily(com.yogaveda.util.Constants.FONT_FAMILY)
                .fontSize(14.px),
