...
fun CreateScreen() {
    ...
    var popularSwitched by remember { mutableStateOf(false) }
    var mainSwitched by remember { mutableStateOf(false) }
                ...
                SimpleGrid(numColumns = numColumns(base = 1, sm = 3)) {
                    Row(
                        ...
                        Switch(
                            ...
                            checked = popularSwitched,
                            onCheckedChange = { popularSwitched = it },
                            size = SwitchSize.LG
                        )
                        SpanText(
                            modifier = Modifier
                    ...
                    Row(
                        ...
                        Switch(
                            modifier = Modifier.margin(right = 8.px),
                            checked = mainSwitched,
                            onCheckedChange = { mainSwitched = it },
                            size = SwitchSize.LG
                        )
                        SpanText(
                            modifier = Modifier
            ...
            Box (
                ...
                Button(
                    attrs = Modifier
                        ...
                        .onClick { println("Preview button Clicked") }
                        .toAttrs()
                ) {
                    SpanText(
